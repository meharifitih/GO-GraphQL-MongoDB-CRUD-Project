...
func (ec *executionContext) field_Mutation_createJobListing_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNCreateJobListingInput2githubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐCreateJobListingInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Mutation_updateJobListing_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["id"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNUpdateJobListingInput2githubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐUpdateJobListingInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg1
...
func (ec *executionContext) _Mutation_createJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNJobListing2ᚖgithubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐJobListing(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_jobs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.JobListing)
	fc.Result = res
	return ec.marshalNJobListing2ᚕᚖgithubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐJobListingᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNCreateJobListingInput2githubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐCreateJobListingInput(ctx context.Context, v any) (model.CreateJobListingInput, error) {
...
func (ec *executionContext) marshalNJobListing2githubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v model.JobListing) graphql.Marshaler {
	return ec._JobListing(ctx, sel, &v)
}

func (ec *executionContext) marshalNJobListing2ᚕᚖgithubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐJobListingᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.JobListing) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNJobListing2ᚖgithubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐJobListing(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNJobListing2ᚖgithubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v *model.JobListing) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUpdateJobListingInput2githubᚗcomᚋmeharifitiᚋgraphQLᚑgoᚋgraphᚋmodelᚐUpdateJobListingInput(ctx context.Context, v any) (model.UpdateJobListingInput, error) {
